...
import useStyles from './stylesWholeReq';

export default function WholeRequests() {
            ...
            <div className={classes.div}>
              <Card className={classes.card}>
                ...
                <CardActions className={classes.cardActions}>
                  <Button size="small" color="primary" onClick={() => {context.updateRequest(request.name,request.email,'Accept')}}><DeleteIcon fontSize="small" /> Accept</Button>
                  <Button size="small" color="primary" onClick={() => {context.updateRequest(request.name,request.email,'Decline')}}><DeleteIcon fontSize="small" /> Decline</Button>
                </CardActions>
              </Card>
            </div>
          )
